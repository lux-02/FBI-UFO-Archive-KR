...
| Public OCR and translation dataset | `dataset/` | Part 01-16 OCR and Korean translation exports complete |
...
The current public dataset includes OCR output and Korean translation exports for Part 01-16.
...
| 13 | `docs/ufo13.pdf` | 148 | 1,064 | `not_approved` |
| 14 | `docs/ufo14.pdf` | 141 | 1,080 | `not_approved` |
| 15 | `docs/ufo15.pdf` | 77 | 654 | `not_approved` |
| 16 | `docs/ufo16.pdf` | 169 | 1,510 | `not_approved` |

The dataset currently contains 13,218 Korean translation units available for public review.
...
shasum -a 256 docs/ufo13.pdf
shasum -a 256 docs/ufo14.pdf
shasum -a 256 docs/ufo15.pdf
shasum -a 256 docs/ufo16.pdf
```
...
현재 공개 데이터셋에는 Part 01-16의 OCR 추출 결과와 한국어 번역 결과물이 포함되어 있습니다.
...
총 13,218개의 한국어 번역 unit이 공개 검토 가능한 상태로 export되어 있습니다.
